 ...
 *             * workaround to enable usage of inverted card-detect signal
 *
 *     2012KW12 - melchior.franz:
 *             * prevent excess enabling of fixed regulator (fixes wl1271)
 *                     see: https://development.ginzinger.com/armlinux/wiki/MelchiorfLogs12Kw9-1
 ***********************************************************************/
