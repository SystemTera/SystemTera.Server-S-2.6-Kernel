 ...
 * hack is taken from emtrion-kernel and neccessary for data coherency between fcb, uboot and kernel
 * TODO
 */
//#define BAD_BLK_MARKER_SP_OFFS (NAND_CHUNKS * SPARE_LEN)	/* micron MT29F2G16ABBEA: 192 */
#define BAD_BLK_MARKER_SP_OFFS 0x6	// FIXME, hack to be compliant with usable NAND FCB 
