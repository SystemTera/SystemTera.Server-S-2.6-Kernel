 ...
 * enable mailbox and register dumps
 */
#ifdef CAN_FLEXCAN_DUMPS
...
#endif
#ifdef CONFIG_CAN_FLEXCAN_STATISTICS
	FLEXCAN_ATTR_STAT_BUS,
	FLEXCAN_ATTR_STAT_BUS_WAKE_INT,
	FLEXCAN_ATTR_STAT_BUS_CRTL_TX_WARNING,
	FLEXCAN_ATTR_STAT_BUS_CRTL_RX_WARNING,
	FLEXCAN_ATTR_STAT_BUS_BUSOFF,
	FLEXCAN_ATTR_STAT_BUS_PROT_BIT1,
	FLEXCAN_ATTR_STAT_BUS_PROT_BIT0,
	FLEXCAN_ATTR_STAT_BUS_ACK,
	FLEXCAN_ATTR_STAT_BUS_CRC,
	FLEXCAN_ATTR_STAT_BUS_PROT_FORM,
	FLEXCAN_ATTR_STAT_BUS_PROT_STUFF,
	FLEXCAN_ATTR_STAT_BUS_CRTL_TX_PASSIVE,
	FLEXCAN_ATTR_STAT_BUS_CRTL_RX_PASSIVE,
	FLEXCAN_ATTR_STAT_BUS_MISC,
	FLEXCAN_ATTR_STAT_MBM_RX_FIFO_OVERRUN,
	FLEXCAN_ATTR_STAT_MBM_RX_FIFO_FILLWARN,
	FLEXCAN_ATTR_STAT_MBM_RX_FIFO_DROPPED,
	FLEXCAN_ATTR_STAT_MBM_RX_MB_DROPPED,
	FLEXCAN_ATTR_STAT_MBM_TX_ABORT,
	FLEXCAN_ATTR_STAT_NETIF_QUEUE_START,
	FLEXCAN_ATTR_STAT_NETIF_QUEUE_WAKE,
	FLEXCAN_ATTR_STAT_NETIF_QUEUE_STOP,
	FLEXCAN_ATTR_STAT_NETIF_QUEUE_STOPPED,
	FLEXCAN_ATTR_STAT_NETIF_CARRIER_ON,
	FLEXCAN_ATTR_STAT_NETIF_CARRIER_OFF,
#endif
	FLEXCAN_ATTR_MAX
};
...
#ifdef CONFIG_CAN_FLEXCAN_STATISTICS
	[FLEXCAN_ATTR_STAT_BUS] =
	    __ATTR(stat.bus, 0444, flexcan_show_attr, NULL),
	[FLEXCAN_ATTR_STAT_BUS_WAKE_INT] =
	    __ATTR(stat.bus_wake_int, 0444, flexcan_show_attr, NULL),
	[FLEXCAN_ATTR_STAT_BUS_CRTL_TX_WARNING] =
	    __ATTR(stat.bus_crtl_tx_warning, 0444, flexcan_show_attr, NULL),
	[FLEXCAN_ATTR_STAT_BUS_CRTL_RX_WARNING] =
	    __ATTR(stat.bus_crtl_rx_warning, 0444, flexcan_show_attr, NULL),
	[FLEXCAN_ATTR_STAT_BUS_BUSOFF] =
	    __ATTR(stat.bus_off, 0444, flexcan_show_attr, NULL),
	[FLEXCAN_ATTR_STAT_BUS_PROT_BIT1] =
	    __ATTR(stat.bus_prot_bit1, 0444, flexcan_show_attr, NULL),
	[FLEXCAN_ATTR_STAT_BUS_PROT_BIT0] =
	    __ATTR(stat.bus_prot_bit0, 0444, flexcan_show_attr, NULL),
	[FLEXCAN_ATTR_STAT_BUS_ACK] =
	    __ATTR(stat.bus_ack, 0444, flexcan_show_attr, NULL),
	[FLEXCAN_ATTR_STAT_BUS_CRC] =
	    __ATTR(stat.bus_crc, 0444, flexcan_show_attr, NULL),
	[FLEXCAN_ATTR_STAT_BUS_PROT_FORM] =
	    __ATTR(stat.bus_prot_form, 0444, flexcan_show_attr, NULL),
	[FLEXCAN_ATTR_STAT_BUS_PROT_STUFF] =
	    __ATTR(stat.bus_prot_stuff, 0444, flexcan_show_attr, NULL),
	[FLEXCAN_ATTR_STAT_BUS_CRTL_TX_PASSIVE] =
	    __ATTR(stat.bus_crtl_tx_passive, 0444, flexcan_show_attr, NULL),
	[FLEXCAN_ATTR_STAT_BUS_CRTL_RX_PASSIVE] =
	    __ATTR(stat.bus_crtl_rx_passive, 0444, flexcan_show_attr, NULL),
	[FLEXCAN_ATTR_STAT_BUS_MISC] =
	    __ATTR(stat.bus_misc, 0444, flexcan_show_attr, NULL),
	[FLEXCAN_ATTR_STAT_MBM_RX_FIFO_FILLWARN] =
	    __ATTR(stat.mbm_rx_fifo_fillwarn, 0444, flexcan_show_attr, NULL),
	[FLEXCAN_ATTR_STAT_MBM_RX_FIFO_OVERRUN] =
	    __ATTR(stat.mbm_rx_fifo_overrun, 0444, flexcan_show_attr, NULL),
	[FLEXCAN_ATTR_STAT_MBM_RX_FIFO_DROPPED] =
	    __ATTR(stat.mbm_rx_fifo_dropped, 0444, flexcan_show_attr, NULL),
	[FLEXCAN_ATTR_STAT_MBM_RX_MB_DROPPED] =
	    __ATTR(stat.mbm_rx_mb_dropped, 0444, flexcan_show_attr, NULL),
	[FLEXCAN_ATTR_STAT_MBM_TX_ABORT] =
	    __ATTR(stat.mbm_tx_abort, 0444, flexcan_show_attr, NULL),
	[FLEXCAN_ATTR_STAT_NETIF_QUEUE_START] =
	    __ATTR(stat.netif_queue_start, 0444, flexcan_show_attr, NULL),
	[FLEXCAN_ATTR_STAT_NETIF_QUEUE_WAKE] =
	    __ATTR(stat.netif_queue_wake, 0444, flexcan_show_attr, NULL),
	[FLEXCAN_ATTR_STAT_NETIF_QUEUE_STOP] =
	    __ATTR(stat.netif_queue_stop, 0444, flexcan_show_attr, NULL),
	[FLEXCAN_ATTR_STAT_NETIF_QUEUE_STOPPED] =
	    __ATTR(stat.netif_queue_stopped, 0444, flexcan_show_attr, NULL),
	[FLEXCAN_ATTR_STAT_NETIF_CARRIER_ON] =
	    __ATTR(stat.netif_carrier_on, 0444, flexcan_show_attr, NULL),
	[FLEXCAN_ATTR_STAT_NETIF_CARRIER_OFF] =
	    __ATTR(stat.netif_carrier_off, 0444, flexcan_show_attr, NULL)
#endif
};
...
#endif
#ifdef CONFIG_CAN_FLEXCAN_STATISTICS
	case FLEXCAN_ATTR_STAT_BUS:
		return sprintf(buf, "%d\n", flexcan->stat.bus);
	case FLEXCAN_ATTR_STAT_BUS_WAKE_INT:
		return sprintf(buf, "%d\n", flexcan->stat.bus_wake_int);
	case FLEXCAN_ATTR_STAT_BUS_CRTL_TX_WARNING:
		return sprintf(buf, "%d\n", flexcan->stat.bus_crtl_tx_warning);
	case FLEXCAN_ATTR_STAT_BUS_CRTL_RX_WARNING:
		return sprintf(buf, "%d\n", flexcan->stat.bus_crtl_rx_warning);
	case FLEXCAN_ATTR_STAT_BUS_BUSOFF:
		return sprintf(buf, "%d\n", flexcan->stat.bus_off);
	case FLEXCAN_ATTR_STAT_BUS_PROT_BIT1:
		return sprintf(buf, "%d\n", flexcan->stat.bus_prot_bit1);
	case FLEXCAN_ATTR_STAT_BUS_PROT_BIT0:
		return sprintf(buf, "%d\n", flexcan->stat.bus_prot_bit0);
	case FLEXCAN_ATTR_STAT_BUS_ACK:
		return sprintf(buf, "%d\n", flexcan->stat.bus_ack);
	case FLEXCAN_ATTR_STAT_BUS_CRC:
		return sprintf(buf, "%d\n", flexcan->stat.bus_crc);
	case FLEXCAN_ATTR_STAT_BUS_PROT_FORM:
		return sprintf(buf, "%d\n", flexcan->stat.bus_prot_form);
	case FLEXCAN_ATTR_STAT_BUS_PROT_STUFF:
		return sprintf(buf, "%d\n", flexcan->stat.bus_prot_stuff);
	case FLEXCAN_ATTR_STAT_BUS_CRTL_TX_PASSIVE:
		return sprintf(buf, "%d\n", flexcan->stat.bus_crtl_tx_passive);
	case FLEXCAN_ATTR_STAT_BUS_CRTL_RX_PASSIVE:
		return sprintf(buf, "%d\n", flexcan->stat.bus_crtl_rx_passive);
	case FLEXCAN_ATTR_STAT_BUS_MISC:
		return sprintf(buf, "%d\n", flexcan->stat.bus_misc);
	case FLEXCAN_ATTR_STAT_MBM_RX_FIFO_FILLWARN:
		return sprintf(buf, "%d\n", flexcan->stat.mbm_rx_fifo_fillwarn);
	case FLEXCAN_ATTR_STAT_MBM_RX_FIFO_OVERRUN:
		return sprintf(buf, "%d\n", flexcan->stat.mbm_rx_fifo_overrun);
	case FLEXCAN_ATTR_STAT_MBM_RX_FIFO_DROPPED:
		return sprintf(buf, "%d\n", flexcan->stat.mbm_rx_fifo_dropped);
	case FLEXCAN_ATTR_STAT_MBM_RX_MB_DROPPED:
		return sprintf(buf, "%d\n", flexcan->stat.mbm_rx_mb_dropped);
	case FLEXCAN_ATTR_STAT_MBM_TX_ABORT:
		return sprintf(buf, "%d\n", flexcan->stat.mbm_tx_abort);
	case FLEXCAN_ATTR_STAT_NETIF_QUEUE_START:
		return sprintf(buf, "%d\n", flexcan->stat.netif_queue_start);
	case FLEXCAN_ATTR_STAT_NETIF_QUEUE_WAKE:
		return sprintf(buf, "%d\n", flexcan->stat.netif_queue_wake);
	case FLEXCAN_ATTR_STAT_NETIF_QUEUE_STOP:
		return sprintf(buf, "%d\n", flexcan->stat.netif_queue_stop);
	case FLEXCAN_ATTR_STAT_NETIF_QUEUE_STOPPED:
		return sprintf(buf, "%d\n", flexcan->stat.netif_queue_stopped);
	case FLEXCAN_ATTR_STAT_NETIF_CARRIER_ON:
		return sprintf(buf, "%d\n", flexcan->stat.netif_carrier_on);
	case FLEXCAN_ATTR_STAT_NETIF_CARRIER_OFF:
		return sprintf(buf, "%d\n", flexcan->stat.netif_carrier_off);
#endif
	default:
				...
				size_t count)
{
	...
	case FLEXCAN_ATTR_FIFO:
		/*
		 * manfred.schlaegl@ginzinger.com
		 * set correct value for xmit_maxmb in fifo-mode
		 * this is not neccessary for correct function,
		 * but for correct output on show_attr(sysfs) and 
		 * on mailbox-dumps(see below).
		 */
		if(tmp) {
			flexcan->fifo = 1;
			flexcan->xmit_maxmb = FLEXCAN_MAX_FIFO_MB-1;
		} else {
			flexcan->fifo = 0;
		}
		break;
...
#ifdef CONFIG_CAN_FLEXCAN_STATISTICS
	/* reset statistics */
	memset(&dev->stat,0,sizeof(struct flexcan_device_statistics));
#endif
}
