...
struct flexcan_device_statistics {
	/* bus-errors */
	unsigned int bus;
	unsigned int bus_wake_int;
	unsigned int bus_crtl_tx_warning;
	unsigned int bus_crtl_rx_warning;
	unsigned int bus_off;
	unsigned int bus_prot_bit1;
	unsigned int bus_prot_bit0;
	unsigned int bus_ack;
	unsigned int bus_crc;
	unsigned int bus_prot_form;
	unsigned int bus_prot_stuff;
	unsigned int bus_crtl_tx_passive;
	unsigned int bus_crtl_rx_passive;
	unsigned int bus_misc;
	/* mbm */
	unsigned int mbm_rx_fifo_fillwarn;
	unsigned int mbm_rx_fifo_overrun;
	unsigned int mbm_rx_fifo_dropped;
	unsigned int mbm_rx_mb_dropped;
	unsigned int mbm_tx_abort;
	/* netif */
	unsigned int netif_queue_start;
	unsigned int netif_queue_wake;
	unsigned int netif_queue_stop;
	unsigned int netif_queue_stopped;
	unsigned int netif_carrier_off;
	unsigned int netif_carrier_on;
};
#endif
...
struct flexcan_device {
	...
	struct clk *clk;
#ifdef CONFIG_CAN_FLEXCAN_STATISTICS
	struct flexcan_device_statistics stat;
#endif
	int irq;
};
