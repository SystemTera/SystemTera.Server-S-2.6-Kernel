 ...
 *		* get default bits-per-pixel for mxc_ipuv3_fb from 
...
static int mxcfb_setup(struct fb_info *fbi, struct platform_device *pdev)
{
	...
	if (plat_data && !mxcfbi->default_bpp)
		mxcfbi->default_bpp = plat_data->default_bpp;
...
static int mxcfb_probe(struct platform_device *pdev)
{
	 ...
	 * do not display logo, if framebufferconsole is configured
	 * display of logo is done in drivers/video/console/fbcon.c
	 */
