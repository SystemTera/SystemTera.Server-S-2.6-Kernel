/* revert
 * linux/sound/soc/codecs/tlv320aic3110.h
 *
 ...
 *
 * manfred.schlaegl@ginzinger.com : HACKED - MERGED WITH tlv320aic3x
 * 
 */
...
/* This below macro for GPIO is specific to the KC1 Board */
...
/* Headphone Driver ON */
#define HP_DRIVER_ON                    0xC4

/*Headphone Driver OFF */
#define HP_DRIVER_OFF			0x04
...
#define HP_DRIVER_3_9_MS	(BIT3 | BIT2)
 ...
 *----------------------------------------------------------------------------
 */
extern struct snd_soc_dai tlv320aic3110_dai;
 ...
 *
 */
extern struct snd_soc_codec_device soc_codec_dev_tlv320aic3110;
