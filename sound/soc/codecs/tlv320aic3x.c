...
/***********************************************************************
 *	@History:
 *	2013KW07 - melchior.franz:
 *		* make power-on time and ramp-up step time of
 *		  HPOUT_POP_REDUCTION register configurable
 *	2012KW21 - melchior.franz:
 *		* change aic3x_dai.{playback,capture}.channels_min
 *		  from 1 to 2 to allow playing mono sounds
 ***********************************************************************/
...
static const char *aic3x_pop_red_power_on_delay[] =
    { "0us", "10us", "100us", "1ms", "10ms", "50ms", "100ms",
      "200ms", "400ms", "800ms", "2s", "4s" };
static const char *aic3x_pop_red_ramp_up_step_time[] =
    { "0ms", "1ms", "2ms", "4ms" };
...
#define POP_DELAY_ENUM	9
#define POP_STEP_ENUM	10
...
static const struct soc_enum aic3x_enum[] = {
	...
	SOC_ENUM_SINGLE(HPOUT_POP_REDUCTION, 4, 12, aic3x_pop_red_power_on_delay),
	SOC_ENUM_SINGLE(HPOUT_POP_REDUCTION, 2, 4, aic3x_pop_red_ramp_up_step_time),
};
...
static const struct snd_kcontrol_new aic3x_snd_controls[] = {
	...
	*/
	...
	SOC_ENUM("HPOUT Pop Reduction PowerOn Delay", aic3x_enum[POP_DELAY_ENUM]),
	SOC_ENUM("HPOUT Pop Reduction RampUp Step Time", aic3x_enum[POP_STEP_ENUM]),
};
...
struct snd_soc_dai aic3x_dai = {
	...
	.playback = {
		...
		/* melchior.franz@ginzinger.com: changed 1 to 2 */
		.channels_min = 2,
		.channels_max = 2,
		.rates = AIC3X_RATES,
